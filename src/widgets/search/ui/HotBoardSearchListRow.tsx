...
interface HotBoardSearchListRowProps {
 ...
 */
export default function HotBoardSearchListRow({
  keyword,
  count,
  views,
  timer,
}: HotBoardSearchListRowProps) {
  ...
  return (
    <Link href={`/hotBoard/keyword`}>
      <div className="flex cursor-pointer items-center justify-between rounded-xl py-3.5 pl-2 pr-4 hover:bg-gray-100">
